...
namespace IndyBooks
{
    internal class SeedData
    {
        internal static void Initialize(IndyBooksDbContext dbContext)
        {
            ...
            /* TODO: remove this line (and the last TODO line below)
            ...
            var writers = testWriters.Generate(6); // TODO: B) create a collection of 45 writers
                                                    //Books
            ...
            var books = testBooks.Generate(10); // TODO: C) create a collection of 100 books

            //Add the writers collection to the 
